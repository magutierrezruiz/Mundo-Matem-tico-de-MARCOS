# Mundo Matemático de Marcos

Videojuego educativo Android personalizado para **Marcos**, pensado para niños menores de 10 años.
...
- Todos los mensajes, explicaciones, preguntas y resultados se dirigen a **Marcos por su nombre**.
...
4. Ejecuta `Compilar APK - Marcos` o haz un push a `main`.
5. Al terminar, entra al workflow y descarga el artefacto `Mundo_Matematico_Marcos_APK`.
